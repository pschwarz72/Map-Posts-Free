 ...
 * Plugin URI: https://integratedproductivitytools.com/resources/map-posts/
...
class IPTMP_Map_Free extends IPTMP_Map_Posts {
	...
	function insert_map_shortcode ($atts = [], $content = null) {
		...
		//OpenStreetMap maps
		var standardMap = L.tileLayer('https://{s}.tile.osm.org/{z}/{x}/{y}.png',{
			attribution:'Map & Data © <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors'
		}).addTo(map);

		var humanMap = L.tileLayer('https://a.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png',{
			attribution:'Map & Data © <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors'
		});
		...
		//Stamen maps
		var stamentonerMap = L.tileLayer('https://stamen-tiles.a.ssl.fastly.net/toner/{z}/{x}/{y}.png',{
		...
		var stamenterrainMap = L.tileLayer('https://stamen-tiles.a.ssl.fastly.net/terrain/{z}/{x}/{y}.jpg',{
			attribution:'Map © <a href="http://stamen.com">Stamen Design</a>, under <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0, </a>Data © <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors'
		});

		var stamencolorMap = L.tileLayer('https://stamen-tiles.a.ssl.fastly.net/watercolor/{z}/{x}/{y}.jpg',{
			attribution:'Map © <a href="http://stamen.com">Stamen Design</a>, under <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0, </a>Data © <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors'
		});
